...
//         userId: localStorage.getItem('userId') || 'ADMIN_001'
//       });
//     } catch (error) {
...
//         const downloadResponse = await axios.get(`http://localhost:8080/api/resumes/download/${resume.id}`, {
//           responseType: 'blob',
//           withCredentials: true
//         });
...
//           <input
//             type="text"
//             placeholder="Search users by name, email, location, role..."
//             value={searchTerm}
...
//       {/* Users Grid */}
//       <div className="manage-users-grid-container">
//         <div className="manage-users-grid-header">
//           <h3><FontAwesomeIcon icon={faUserFriends} /> User Profiles</h3>
//           <div className="manage-users-grid-stats">
...
//               <div key={user.id} className="manage-users-card">
//                 <div className="manage-users-card-header">
//                   <div className="manage-users-profile-section">
//                     <div className="manage-users-profile-pic">
//                       <img 
//                         src={getProfilePicture(user)} 
//                         alt={user.name}
//                         onError={(e) => {
//                           e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=667eea&color=ffffff&size=100`;
//                         }}
//                       />
//                     </div>
...
//                   <div className="manage-users-info-row">
//                     <div className="manage-users-info-item">
...
//                   <div className="manage-users-info-row">
//                     <div className="manage-users-info-item full-width">
//                       <FontAwesomeIcon icon={faFileAlt} />
//                       <button 
//                         className="manage-users-resume-download-btn"
//                         onClick={() => handleDownloadResume(user.email, user.name)}
//                       >
//                         Download Resume
//                       </button>
...
//                 <div className="manage-users-card-footer">
//                   <div className="manage-users-user-id">
//                     <FontAwesomeIcon icon={faIdCard} />
//                     <span>ID: {user.id}</span>
//                   </div>
//                   <div className="manage-users-verification-status">
//                     {user.emailVerified && (
//                       <span className="manage-users-verified-badge">
...
//                   <tr key={user.id}>
//                     {/* <td>
//                       <span className="manage-users-user-id-badge">
//                         {user.id}
//                       </span>
//                     </td> */}
//                     <td>
